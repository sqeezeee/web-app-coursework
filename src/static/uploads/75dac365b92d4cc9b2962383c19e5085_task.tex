...
на тему «Разработка веб-приложения для логопедического центра с системой
абонементов и личными кабинетами пользователей»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 3.2. Реализация аутентификации пользователей                                              & 7                  & 27.04.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для пользователей, абонементов и домашних заданий         & 7                  & 03.05.2026    &                     \\ \hline
    Задача 3.4. Реализация системы управления абонементами                                           & 12                 & 09.05.2026    &                     \\ \hline
    Задача 3.5. Разработка системы домашних заданий                                                  & 6                  & 15.05.2026    &                     \\ \hline
