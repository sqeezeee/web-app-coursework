...
\begin{center}
    ...
    Иванову Ивану Ивановичу, % нужно указать в дательном падеже (задание кому?)
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 3.2. Реализация модуля авторизации и разграничения прав доступа (диспетчер/курьер)        & 7                  & 27.04.2026    &                     \\ \hline
    Задача 3.3. Разработка CRUD-интерфейса для управления заказами, автопарком и штатом курьеров     & 7                  & 03.05.2026    &                     \\ \hline
    Задача 3.4. Интеграция картографических сервисов и реализация алгоритма оптимизации маршрутов    & 12                 & 09.05.2026    &                     \\ \hline
    Задача 3.5. Разработка системы мониторинга статусов доставки и формирования отчетности           & 6                  & 15.05.2026    &                     \\ \hline
