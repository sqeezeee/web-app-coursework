...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/screen_register.png}
        \caption{Страница регистрации}
        \label{fig:screen_register}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/screen_login.png}
...
Управление сущностями системы осуществляется через реализованные CRUD-интерфейсы. Взаимодействие с реляционной базой данных PostgreSQL инкапсулировано через объектно-реляционное отображение (ORM) \texttt{SQLAlchemy}. 
...
Полученные статистические данные передаются в HTML-шаблоны, где визуализируются в двух форматах: в виде динамической шкалы готовности (Progress Bar) внутри каждого проекта и в виде интерактивной круговой диаграммы на базе библиотеки \texttt{Chart.js} на главной панели управления. Результат работы модуля представлен на рисунке \ref{fig:screen_dashboard}.
